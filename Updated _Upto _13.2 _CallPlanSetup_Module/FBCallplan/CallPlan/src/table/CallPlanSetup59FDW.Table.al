table 70241756 CallPlanSetup59FDW
{
...
#pragma warning restore LC0013
        ...
        field(18; "InsideSalesperson Code"; Option)
        {
            DataClassification = CustomerContent;
            Caption = 'Source for Inside Salesperson Code';
            OptionMembers = "Call plan","User setup";
        }
    }
    keys
    {
    ...
    internal procedure DisablingCuttoffTime(var EnableCutOffRestriction: Boolean)
    var
